...
We run a subscription-based business model to create revenue for various illustrators.

**Step 6**. Every subscriber gets an exclusive product that will never be replicated in analog format and can be sent to friends and family via India Post with/without an accompanying message.

**Step 7**. Every handmade illustrated postcard is available only on subscription, so all payouts to illustrators are only valid for shipped goods, and only unshipped goods can be returned to the original author on demand.

<script type="text/javascript" src="https://cdnjs.buymeacoffee.com/1.0.0/button.prod.min.js" data-name="bmc-button" data-slug="yourmailproject" data-color="#ffffff" data-emoji=""  data-font="Cookie" data-text="Come shop with us!" data-outline-color="#d54321" data-font-color="#494949" data-coffee-color="#FFDD00" ></script>

**Step 8**. We handle complaints, inventory, operations, packaging, shipping, suggestions, and more. We do not accept returns from subscribers.
