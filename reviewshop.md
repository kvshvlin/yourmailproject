...
We ship blank postcards to artists. Postcards that they can illustrate upon. Return them to us when they are done, so we can list them for sale on various platforms, and grow as a collective by sharing profits with artists.
